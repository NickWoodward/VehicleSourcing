...
export const HeroText = (props: Props) => {
  ...
  return (
    <div {...props} className={classes}>
      ...
      <h1 className="title animate-text invisible opacity-0 xl:mt-2  text-2xl   sm:text-3xl lg:text-4xl xl:text-5xl font-bold  tracking-tighter text-gray-700">
        {/* Hassle Free Purchasing */}
        Lorem, Ipsum Dolor
      </h1>
      <p className="tagline animate-text invisible opacity-0  mt-3 sm:mt-5 max-w-sm text-base xs:text-lg sm:text-xl lg:text-xl xl:text-2xl text-gray-500">
