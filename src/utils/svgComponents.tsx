...
export const CarIcon2 = (props: Props) => {
  ...
  return (
    <div {...props} className={classes}>
      <svg xmlns="http://www.w3.org/2000/svg" className="absolute top-0 left-0 h-full translate-x-[5px] translate-y-[10px]" viewBox="0 0 365.61 459.98">
        <g>
          <g>
            <path className="fill-[#14a0de]" d="m317.5,225.17v-87.93c0-4.55-.7-8.91-1.95-13.05l10.46-1.48c6.37-.91,11.12-6.37,11.12-12.81v-16.58c0-7.15-5.79-12.94-12.94-12.94h-19.46l-9.65-41.52C289.77,15.98,269.65,0,246.16,0h-126.71c-23.5,0-43.62,15.98-48.93,38.86l-9.65,41.52h-19.46c-7.15,0-12.94,5.79-12.94,12.94v16.58c0,6.44,4.74,11.9,11.12,12.81l10.46,1.48c-1.25,4.13-1.95,8.5-1.95,13.05v87.93c0,7.15,5.79,12.94,12.94,12.94h40.2c6.19,0,11.52-4.39,12.7-10.47l5.71-29.39h126.3l5.71,29.39c1.18,6.08,6.51,10.47,12.7,10.47h40.2c7.15,0,12.94-5.79,12.94-12.94ZM99.5,45.6c2.17-9.33,10.37-15.84,19.95-15.84h126.71c9.57,0,17.77,6.51,19.94,15.84l11.01,47.4H88.49l11.01-47.4Zm19.29,116.12l-41.6-1.81c-3.47-.15-6.27-2.87-6.47-6.34-.31-5.42-.5-13.48.47-19.95.61-4.04,4.59-6.63,8.53-5.54,12.74,3.52,30.69,8.26,38.45,10.3,2.36.62,4.2,2.46,4.82,4.83l2.64,10.03c1.16,4.41-2.29,8.69-6.84,8.49Zm99.72-6.13c0,2.41-1.95,4.36-4.36,4.36h-62.71c-2.41,0-4.36-1.95-4.36-4.36v-8.33c0-2.41,1.95-4.36,4.36-4.36h62.71c2.41,0,4.36,1.95,4.36,4.36v8.33Zm76.36-2.02c-.2,3.47-3,6.19-6.47,6.34l-41.59,1.81c-4.56.2-8.01-4.08-6.84-8.49l2.64-10.03c.62-2.36,2.46-4.2,4.82-4.83,7.76-2.04,25.71-6.78,38.45-10.3,3.94-1.09,7.92,1.5,8.53,5.54.97,6.47.78,14.53.47,19.95Z"/>
            <path className="fill-[#203a72]" d="m5.63,459.98c-1.75,0-3.37-.79-4.44-2.18-1.07-1.37-1.44-3.14-1.01-4.83l45.43-179.3c.63-2.5,2.88-4.25,5.45-4.25h29.73c1.75,0,3.37.79,4.44,2.17,1.07,1.38,1.45,3.14,1.02,4.84l-45.32,179.31c-.63,2.5-2.88,4.24-5.46,4.24H5.63Z"/>
            <path className="fill-[#203a72]" d="m330.25,459.98c-2.58,0-4.83-1.74-5.46-4.23l-45.43-179.31c-.43-1.7-.06-3.47,1.01-4.84,1.08-1.38,2.7-2.18,4.44-2.18h29.84c2.58,0,4.83,1.75,5.46,4.25l45.32,179.3c.43,1.7.06,3.47-1.02,4.84-1.07,1.38-2.69,2.17-4.44,2.17h-29.73Z"/>
            <path className="fill-[#203a72]" d="m167.58,459.78c-3.1,0-5.63-2.53-5.63-5.63v-38.84c0-3.11,2.52-5.63,5.63-5.63h28.82c3.1,0,5.63,2.53,5.63,5.63v38.84c0,3.1-2.53,5.63-5.63,5.63h-28.82Z"/>
            <path className="fill-[#203a72]" d="m167.58,373.41c-3.1,0-5.63-2.53-5.63-5.63v-38.85c0-3.1,2.52-5.63,5.63-5.63h28.82c3.1,0,5.63,2.53,5.63,5.63v38.85c0,3.1-2.53,5.63-5.63,5.63h-28.82Z"/>
            <path className="fill-[#203a72]" d="m167.58,287.02c-3.1,0-5.63-2.53-5.63-5.63v-38.84c0-3.1,2.52-5.63,5.63-5.63h28.82c3.1,0,5.63,2.53,5.63,5.63v38.84c0,3.1-2.53,5.63-5.63,5.63h-28.82Z"/>
          </g>
        </g>
      </svg>
    </div>
