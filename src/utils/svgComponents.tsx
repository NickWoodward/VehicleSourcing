...
export const KeyIcon1 = (props: Props) => {
  const classes = cn("relative", props.className);
  return (
    <div {...props} className={classes}>
<svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 100 125">
          <path className="cls-3" fill="#203a72" strokeWidth="0px" d="m4030.32,87.55c-61.57,0-111.48,49.91-111.48,111.48s49.91,111.48,111.48,111.48,111.48-49.91,111.48-111.48-49.91-111.48-111.48-111.48Zm0,189.43c-43.05,0-77.95-34.9-77.95-77.95s34.9-77.95,77.95-77.95,77.95,34.9,77.95,77.95-34.9,77.95-77.95,77.95Z"/>
          <path className="cls-1" fill="#14a0de" strokeWidth="0px" d="m4030.32,131.31c-37.34,0-67.71,30.38-67.71,67.71s30.38,67.71,67.71,67.71,67.71-30.38,67.71-67.71-30.38-67.71-67.71-67.71Zm49.89,42.59l-18.68,5.07c-10.63,2.89-21.21-4.8-21.75-15.8l-.95-19.35c18.13,2.79,33.39,14.27,41.38,30.08Zm-35.93,25.13c0,7.71-6.25,13.97-13.97,13.97s-13.97-6.25-13.97-13.97,6.25-13.97,13.97-13.97,13.97,6.25,13.97,13.97Zm-22.48-55.2l-.95,19.34c-.54,11-11.12,18.69-21.75,15.8l-18.68-5.07c7.99-15.81,23.25-27.29,41.38-30.07Zm-47.41,55.2c0-3.05.31-6.02.78-8.94l18.07,6.87c10.3,3.92,14.34,16.35,8.31,25.57l-10.59,16.19c-10.23-10.14-16.58-24.18-16.58-39.69Zm30.36,49.68l12.11-15.05c6.91-8.58,19.98-8.58,26.88,0l12.12,15.06c-7.67,3.96-16.34,6.23-25.55,6.23s-17.89-2.28-25.56-6.24Zm64.89-9.98l-10.59-16.19c-6.03-9.22-1.99-21.65,8.31-25.57l18.09-6.88c.47,2.92.78,5.89.78,8.93,0,15.51-6.36,29.56-16.59,39.7Z"/>
...
export const WheelIcon = (props: Props) => {
    return (
      <div {...props}>
        <svg xmlns="http://www.w3.org/2000/svg" className="flex w-6 h-6" fill="currentColor" strokeWidth="0px" viewBox="0 0 1200 1200">
          <g>

            <path d="m4030.32,87.55c-61.57,0-111.48,49.91-111.48,111.48s49.91,111.48,111.48,111.48,111.48-49.91,111.48-111.48-49.91-111.48-111.48-111.48Zm0,189.43c-43.05,0-77.95-34.9-77.95-77.95s34.9-77.95,77.95-77.95,77.95,34.9,77.95,77.95-34.9,77.95-77.95,77.95Z"/>
            <path  d="m4030.32,131.31c-37.34,0-67.71,30.38-67.71,67.71s30.38,67.71,67.71,67.71,67.71-30.38,67.71-67.71-30.38-67.71-67.71-67.71Zm49.89,42.59l-18.68,5.07c-10.63,2.89-21.21-4.8-21.75-15.8l-.95-19.35c18.13,2.79,33.39,14.27,41.38,30.08Zm-35.93,25.13c0,7.71-6.25,13.97-13.97,13.97s-13.97-6.25-13.97-13.97,6.25-13.97,13.97-13.97,13.97,6.25,13.97,13.97Zm-22.48-55.2l-.95,19.34c-.54,11-11.12,18.69-21.75,15.8l-18.68-5.07c7.99-15.81,23.25-27.29,41.38-30.07Zm-47.41,55.2c0-3.05.31-6.02.78-8.94l18.07,6.87c10.3,3.92,14.34,16.35,8.31,25.57l-10.59,16.19c-10.23-10.14-16.58-24.18-16.58-39.69Zm30.36,49.68l12.11-15.05c6.91-8.58,19.98-8.58,26.88,0l12.12,15.06c-7.67,3.96-16.34,6.23-25.55,6.23s-17.89-2.28-25.56-6.24Zm64.89-9.98l-10.59-16.19c-6.03-9.22-1.99-21.65,8.31-25.57l18.09-6.88c.47,2.92.78,5.89.78,8.93,0,15.51-6.36,29.56-16.59,39.7Z"/>
          </g>
        </svg>
      </div>
    );
...
export const TickOutline = (props: Props) => {
  return (
    <div   {...props}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const CloseIcon = (props: IconProps) => {
  const classes = cn("w-4 h-4", props.className);
  return (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={classes} {...props}>
